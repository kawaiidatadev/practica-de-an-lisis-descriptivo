...
Original file is located at
    https://colab.research.google.com/drive/1e1w4L0SUQtzzzDyCIPQaAzNvRlLqBMPd
"""
...
paciente = ['Fernando', 'Alfonso', 'Santiago', 'Lili', 'Rosalia']
tratamiento = ['tratamiento_a','tratamiento_b']
tratamiento_a = [25, 5, 6, 89, 10]
tratamiento_b = [0, 17, 15, 7, 9]
resultado = [25, 5, 6, 89, 10, 0, 17, 15, 7, 9]
...
pd.melt(dataz, id_vars=['paciente'], value_vars=['tratamiento_a', 'tratamiento_b'])
...
# Respuesta 2
# Transforma la tabla a formato tidy
df_tidy = pd.melt(df_pacientes, id_vars=['paciente'], value_vars=['tratamiento_a', 'tratamiento_b'],
                  var_name='tratamiento', value_name='resultado')

# Elimina los tratamientos no realizados (valores -1)
df_tidy_clean = df_tidy[df_tidy['resultado'] != -1]

# Mostrar el DataFrame tidy y limpio
